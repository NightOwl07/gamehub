...
{
    public class TestMenu : ISingletonScript
    {
        private readonly List<string> _charList = new()
        {
            "a_f_m_beach_01",
            "a_f_m_bevhills_01",
            "a_f_m_bevhills_02",
        ...
        public TestMenu(IMenuBuilder menuBuilder)
        {
        ...
        public void TestMenuCmd(TownPlayer player)
        {
            ...
            this._menuBuilder.Create("Choose your character", string.Empty, new Point(150, 150))
                ...
                .AddDynamicListItem("Test Menu Item", "Test Description", this._charList,
                    (item, result) =>
                    {
                        if (string.IsNullOrEmpty(result))
                            return;

                        player.Model = Alt.Hash(result);
                    })
